...
module.exports = function () {
  ...
  }).boolean('watch').boolean('read-only').boolean('quiet').boolean('no-cors').boolean('no-gzip').help('help').alias('help', 'h').version(pkg.version).alias('version', 'v').example('$0 package.json', '').example('$0 file.js', '').example('$0 http://example.com/package.json', '').epilog('https://github.com/typicode/json-server').require(1, 'Missing <source> argument').argv;
